  ...
  return (
    <Fragment>
                  ...
                  <ul className="lab-ul">
                    <li>
                      <div className="sr-left">
                        <img
                          src="/public/assets/images/about/icon/03.jpg"
                ...
                <div className="section-wrapper">
                  <ul className="lab-ul">
                    <li>
                      <div className="sr-left">
                        <img
                          src="/public/assets/images/about/icon/01.jpg"
                          alt="about icon rajibraj91 rajibraj"
                        />
                      </div>
                      <div className="sr-right">
                ...
                <div className="section-wrapper">
                  <ul className="lab-ul">
                    <li>
                      <div className="sr-left">
                        <img
                          src="/public/assets/images/about/icon/02.jpg"
                          alt="about icon rajibraj91 rajibraj"
                        />
                      </div>
                      <div className="sr-right">
              ...
              <div className="col">
                <div className="sf-left">
                  <div className="sfl-thumb">
                    <img src={StudentFeedbackLeftImg} alt="student feedback" />
                    <a
      ...
      <div
        ...
        style={{ background: `url(${AchieveGoalsBg})` }}
      >
        <div className="container">
          <div className="section-header text-center">
